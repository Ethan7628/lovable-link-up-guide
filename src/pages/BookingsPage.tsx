...
const BookingsPage = () => {
    ...
    duration: 0.6
      ...
      <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        <CardContent>
          ...
          {booking.notes && <div className="bg-gray-50 rounded-lg p-3 mb-4">
          ...
          <div className="flex space-x-2">
            ...
            {isPast && booking.status === 'completed' && <>
                <Button className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700" size="sm">
                  Leave Review
                </Button>
  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-0 py-[32px]">
        {/* Page Header */}
        <motion.div initial={{
        opacity: 0,
        y: 20
        ...
        <Tabs defaultValue="upcoming" className="w-full">
          ...
          <TabsContent value="upcoming" className="space-y-6">
            {upcomingBookings.length > 0 ? upcomingBookings.map(booking => <BookingCard key={booking.id} booking={booking} />) : <motion.div initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
          ...
          <TabsContent value="past" className="space-y-6">
            {pastBookings.length > 0 ? pastBookings.map(booking => <BookingCard key={booking.id} booking={booking} isPast />) : <motion.div initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
